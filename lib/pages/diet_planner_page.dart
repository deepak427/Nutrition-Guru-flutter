...
import 'package:nutrition_guru/api/workflow_api.dart';
...
class _DietPlannerPageState extends State<DietPlannerPage> {
  ...
  void apiCall(String dietInput) async {
    dietPlannerResponse = await makeWorkflowApiRequest(jsonEncode(dietInput));
    setState(() {
      loading = !loading;
      submitText = "Resubmit";
    });
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: SizedBox(
                              child: ElevatedButton(
                                onPressed: submitText == "Submitting"
                                    ? null
                                    : () {
                                        if (questionNumber <
                                          ...
                                          Map<String, dynamic> dietInput = {};

                                          for (var question in questionsList) {
                                            dietInput[question.title] =
                                                question.selected;
                                          }

                                          apiCall(jsonEncode(dietInput));
                                        }
                                      },
                                style: ButtonStyle(
